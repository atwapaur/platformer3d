...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private float lastForwardInfluencedCamY;
        ...
        private void FixedUpdate()
        {
            ...
            /*if (m_Input.x != 0 || m_Input.y != 0) {
                //rotate the Player in the direction of the mainCam forward
                float inputVerti = 0f;
                if (m_Input.y < 0) {
                    inputVerti = 180f;
                }

                float inputHoriz = (90f * m_Input.x);
                if (m_Input.y < 0) {
                    inputHoriz *= m_Input.y; //-1
                }
                
                targetAngleY = m_Camera.transform.eulerAngles.y + inputVerti + inputHoriz;

                transform.rotation = Quaternion.Euler(transform.eulerAngles.x, targetAngleY, transform.eulerAngles.z);
            }*/
        ...
        private void RotateView()
        {
            ...
            //m_MouseLook.LookRotation(playerPivot, m_Camera.transform);
        }
